...
const VENUE_ASN = process.env.VENUE_ASN || 'AS00000';           // TODO: set to KANOPI WiFi ASN
const VENUE_ASN_NAME = process.env.VENUE_ASN_NAME || 'KANOPI'; // TODO: set to KANOPI ISP name
const VENUE_IPV4_PREFIXES = [];   // TODO: populate with KANOPI WiFi IP ranges
const VENUE_IPV6_PREFIX = '';     // TODO: populate with KANOPI WiFi IPv6 prefix if any
